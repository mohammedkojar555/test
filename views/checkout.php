	...
	<div class="container-fluid">
		...
		echo'
			<div class="col-75">
				...
				<form id="checkout_form" action="'.site_url('home/checkout_process').'" method="POST" class="was-validated">
			...
			echo"<script>window.location.href = '".site_url('home/checkout')."'</script>";
		}
		?>
